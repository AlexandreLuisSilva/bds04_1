...
public class EventControllerIT {
	...
	public void insertShouldReturn401WhenNoUserLogged() throws Exception {
		...
		EventDTO dto = new EventDTO(null, "Novo evento", LocalDate.of(2021, 5, 18), "https://novoevento.com.br", 1L);
	...
	public void insertShouldInsertResourceWhenClientLoggedAndCorrectData() throws Exception {
		...
		EventDTO dto = new EventDTO(null, "Novo evento", nextMonth, "https://novoevento.com.br", 1L);
		String jsonBody = objectMapper.writeValueAsString(dto);
		...
		result.andExpect(jsonPath("$.name").value("Novo evento"));
		result.andExpect(jsonPath("$.date").value(nextMonth.toString()));
		result.andExpect(jsonPath("$.url").value("https://novoevento.com.br"));
	...
	public void insertShouldReturn422WhenAdminLoggedAndBlankName() throws Exception {
		...
		EventDTO dto = new EventDTO(null, "      ", nextMonth, "https://novoevento.com.br", 1L);
		String jsonBody = objectMapper.writeValueAsString(dto);
	...
	public void insertShouldReturn422WhenAdminLoggedAndPastDate() throws Exception {
		...
		EventDTO dto = new EventDTO(null, "Novo evento", pastMonth, "https://novoevento.com.br", 1L);
		String jsonBody = objectMapper.writeValueAsString(dto);
	...
	public void insertShouldReturn422WhenAdminLoggedAndNullCity() throws Exception {
		...
		EventDTO dto = new EventDTO(null, "Novo evento", nextMonth, "https://novoevento.com.br", null);
		String jsonBody = objectMapper.writeValueAsString(dto);
